<template>
    <div id="user">
      <div class="card card-body mt-8 align-left col-md-15">
        ...
        <br>
        <h4 class="texto-personalizado">Seleccione la imagen que representa la estructura de un <strong>arreglo</strong> que se necesita para resolver el problema:</h4>
        <br>
        <div class="figuras">
          <div
        ...
        <br>
        <br>
        <h4 class="texto-personalizado">Seleccione la declaración correcta del arreglo <strong>nombres</strong> y la variable que va a permitir almacenar los nombres en el arreglo: </h4>
        <br>
        <div class="figuras">
          <div
  ...
  import Carga from "../../components/CargarArrayEj.vue";
  import Elementos from "../../components/ElementosArrayEj.vue";
  import Figura1 from '@/assets/ArrayImages/Array 1.png';
  import Figura2 from '@/assets/ArrayImages/Array 2.png';
  import Figura3 from '@/assets/ArrayImages/Array 3.png';
  import Figura4 from '@/assets/ArrayImages/Array 4.png';
  import Figura5 from '@/assets/ArrayImages/Array 5.png';
  import Figura6 from '@/assets/ArrayImages/Array 6.png';
  import Figura7 from '@/assets/ArrayImages/Array 7.png';
  import Figura8 from '@/assets/ArrayImages/Array 8.png';
  ...
  export default {
    ...
    methods: {
      ...
      finish() {
        router.push('/algoritmoArrayEj').then(() => {
          window.scrollTo(0, 0);
        });
      },
