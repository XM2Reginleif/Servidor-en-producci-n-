<template>
    <div>
      <h4 class="texto-personalizado">Seleccione los elementos que se necesitan para poder resolver el problema:</h4>
      <p><span style="font-weight: bold;">Nota:</span> Entiendase que <strong>(elementos)</strong> pueden ser: <strong>(condicionales, estructuras de repetición, variables y operaciones, arreglos e impresiones y solicitudes por pantalla)</strong>.</p>
