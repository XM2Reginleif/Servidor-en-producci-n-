<template>
    <div>
      <h4 class="texto-personalizado">De acuerdo al tema <strong>carga de datos en un arreglo</strong>, ordene de forma correcta los elementos que llevan a cabo este proceso:</h4>
      <br>
      <div>
  ...
  export default {
    ...
    methods: {
      verificarOrden() {
        const ordenEsperado = ["for", "(", "i = 0;", "i < cantidad;", "i++", ")"];
