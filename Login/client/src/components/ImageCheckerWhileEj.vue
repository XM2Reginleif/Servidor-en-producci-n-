<template>
    ...
    import image1 from '@/assets/whileImages/while 9.png'
    import image2 from '@/assets/whileImages/while 10.png'
    import image3 from '@/assets/whileImages/while 11.png'
    import image4 from '@/assets/whileImages/while 12.png'
    import image5 from '@/assets/whileImages/while 13.png'
    import image6 from '@/assets/whileImages/while 14.png'
    import image7 from '@/assets/whileImages/while 15.png'
    import image8 from '@/assets/whileImages/while 16.png'
    import image9 from '@/assets/whileImages/while 17.png'
    import image10 from '@/assets/whileImages/while 18.png'
    export default {
      ...
      created() {
        this.puzzle = this.puzzle.concat(this.getImages(this.correct, 4), this.correct)
        this.shuffleImages()
      },
      methods: {
        hideModule() {
        ...
        finish() {
          router.push('/abstraccionWhileEj')
        },
