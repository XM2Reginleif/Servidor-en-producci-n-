<template>
    <div>
      <h4 class="texto-personalizado">De acuerdo a la <strong>sintaxis del condicional Switch</strong>, 
        ordene de forma correcta los elementos dentro de un bloque de instrucciones <strong>(case)</strong>:</h4>
      <br>
  ...
  export default {
    ...
    methods: {
      verificarOrden() {
        const ordenEsperado = ["case 1:", "instrucción (mensaje)", "break;"];
      ...
      verificarOrden2() {
        const ordenEsperado2 = ["case 2:", "instrucción (mensaje)", "break;"];
...
.bg-blue {
    background-color: rgba(8, 11, 58, 0.644);
  }
...
.gray-background {
  background-color: hsl(261, 78%, 34%); /* Fondo gris claro */
}
